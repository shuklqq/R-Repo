...
public class LargestCombinationWithBitwiseANDGreaterThanZero {
    /*
    Approach 1 : Calculating the number of candidates that have set bit on a specific bit location and keeping track of
                 that using a 24 size array.
    Complexity Analysis :
        Time Complexity : O(n * 24) = O(n)
        Space Complexity : O(n)
     */
    public int largestCombination(int[] candidates) {
        int[] bitCounter = new int[24];
        for(int a = 0 ; a < 24 ; a++){
